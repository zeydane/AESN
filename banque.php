...
$con=mysqli_connect("localhost","root","","annuaire");
...
<body>
    ...
    <section class="container py-5">
        <div class="row justify-content-center my-5">
          ...
          <?php  
                $sql= "select * from table1 where secteur='Banque' AND boo=true ";
              $resultat = mysqli_query($con,$sql);
              if(mysqli_num_rows($resultat)>0){
              while($rs=mysqli_fetch_assoc($resultat)){   
           ?>

        <section class="">
        <div class="container">
            <div class="recent-work-header row text-center pb-5">
                <h2 class="col-md-6 m-auto h2 semi-bold-600 py-5">Resultat</h2>
            </div>
            <div class="row gy-5 g-lg-5 mb-4">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <?php $pic = ($rs["profil"] <> "" ) ? $rs["profil"] : "no_avatar.png" ;
                       echo '<img class="recent-work-img card-img" src="P/profils/'.$rs["profil"].'" alt="Card image">'  ?>
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                <h3 class="card-title light-300"><?php  echo $rs['logo']?></h3>
                                <p class="card-text"><?php  echo $rs['nom']?></p>
                            </div>
                        </div>
                    </a>
                </div><!-- End Recent Work -->
        ...
        <div class="row">
            <div class="btn-toolbar justify-content-center pb-4" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2" role="group" aria-label="First group">
                    <button type="button" class="btn btn-secondary text-white">Precedant</button>
                </div>
                ...
                <div class="btn-group" role="group" aria-label="Third group">
                    <button type="button" class="btn btn-secondary text-white">Suivant</button>
                </div>
            </div>
        </div>
    </section>
